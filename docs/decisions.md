...
Complete, append-only decision log. Every decision ID from D-001 through D-196 appears below with its source section and status.
...
- **Total decisions:** 196 (D-001 through D-196)
- **Locked:** 189
- **Tentative:** 1 (D-181)
