...
Complete, append-only decision log. Every decision ID from D-001 through D-195 appears below with its source section and status.
...
- **Superseded** — Replaced by a later decision; the superseding D-### is named. (Currently: D-185 routing target by D-191; D-108 range framing by D-195.)
...
- **Total decisions:** 195 (D-001 through D-195)
- **Locked:** 188
- **Tentative:** 1 (D-181)
...
- **Superseded:** 2 (D-185 routing target by D-191; D-108 range framing by D-195)
