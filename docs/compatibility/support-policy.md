...
- **Tier 1 — automated, blocking (D-120).** The six verified targets in the
  ...
  2022 Express/Standard, on Linux containers. These are exercised in CI and are
  the supported core.
- **Tier 2 — manual attestation, best-effort (D-121/D-164).** SQL Server
  2012/2014/2016 (Windows), Azure SQL Managed Instance, and Azure SQL Database.
  These are **Unverified until a real attestation lands** (see
...
## Experimental / pending at 1.0
- All Tier-2 targets, until attested.
...
- Tier-2 attestations beyond the 4-of-5 release gate (§11.6) — the remaining
  targets can attest later without blocking the line.
